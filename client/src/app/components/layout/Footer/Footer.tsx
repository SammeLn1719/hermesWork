...
const Footer:React.FunctionComponent = () => {
  return <footer className="bg-dark-blue">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Sekibun team™</a>. All Rights Reserved.
          </span>
